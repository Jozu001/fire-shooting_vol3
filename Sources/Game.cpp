...
// TODO: 砲台を青い壁に沿って上下に動かす。(C)                               実装:HW16A167_渕　崇洋
...
int     cannonDirection;//!< 砲台の向き　1:up / -1:down   //実装:HW16A167_渕　崇洋
...
void Start()
{
    ...
    cannonDirection = 1;        //実装:HW16A167_渕　崇洋
